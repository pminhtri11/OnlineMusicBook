				...
				<div class="col-lg-7 col-md-7">
					<div class="header__top__right">
						...
						<div class="header__top__right__auth btn btn-warning">
							<a href="${pageContext.request.contextPath}/logout"><i class="fa fa-user "></i> Log Out</a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-lg-6">
				...
				<ul>
					...
					<li><a href="${pageContext.request.contextPath}/cart?userid=${sessionScope.User.id}">Check Out</a></li>
					<li><a href="${pageContext.request.contextPath}/purchasehistory?userid=${sessionScope.User.id}">Purchase History</a></li>
